...
/* Based on CPU DB 56F8006_32_LQFP, version 3.00.169 (RegistersPrg V2.24) */
...
typedef volatile struct {
  ...
  #define PWM_CTRL_ISENS0_MASK          4U
  #define PWM_CTRL_ISENS1_MASK          8U
  ...
  #define PWM_CTRL_ISENS_MASK           12U
  #define PWM_CTRL_ISENS_BITNUM         2U
  ...
  /*** PWM_FLTACK - PWM fault status acknowledge register; 0x0000F022 ***/
  union {
    word Word;
  } PWM_FLTACK_STR;
  
  #define PWM_FLTACK_DT0_FTACK0_MASK    1U
  #define PWM_FLTACK_DT1_MASK           2U
  #define PWM_FLTACK_DT2_FTACK1_MASK    4U
  #define PWM_FLTACK_DT3_MASK           8U
  #define PWM_FLTACK_DT4_FTACK2_MASK    16U
  #define PWM_FLTACK_DT5_MASK           32U
  ...
  /*** PWM_DMAP2 - PWM disable mapping register two; 0x0000F02F ***/
  union {
    word Word;
  } PWM_DMAP2_STR;
  ...
  #define PWM_PORT_PORT4_MASK           16U
  #define PWM_PORT_PORT5_MASK           32U
  #define PWM_PORT_PORT6_MASK           64U
  #define PWM_PORT_PORT_MASK            127U
...
typedef volatile struct {
  ...
  /*** ADC0_ADCSC2 - ADC0 Status and control register; 0x0000F061 ***/
  union {
    word Word;
  } ADC0_ADCSC2_STR;
...
typedef volatile struct {
  ...
  /*** ADC1_ADCSC2 - ADC1 Status and control register; 0x0000F081 ***/
  union {
    word Word;
  } ADC1_ADCSC2_STR;
...
*******************************************/
typedef volatile struct {
  /*** SCI_RATE - QSCI 0 Baud Rate Register; 0x0000F0E0 ***/
  union {
    word Word;
  } SCI_RATE_STR;
  ...
  /*** SCI_CTRL1 - QSCI 0 Control Register; 0x0000F0E1 ***/
  union {
    word Word;
  } SCI_CTRL1_STR;
  ...
  /*** SCI_CTRL2 - QSCI 0 Control Register 2; 0x0000F0E2 ***/
  union {
    word Word;
  } SCI_CTRL2_STR;
  ...
  /*** SCI_STAT - QSCI 0 Status Register; 0x0000F0E3 ***/
  union {
    word Word;
  } SCI_STAT_STR;
  ...
  /*** SCI_DATA - QSCI 0 Data Register; 0x0000F0E4 ***/
  union {
    word Word;
  } SCI_DATA_STR;
...
*******************************************/
typedef volatile struct {
  /*** SPI_SCTRL - QSPI 0 Status and Control Register; 0x0000F100 ***/
  union {
    word Word;
  } SPI_SCTRL_STR;
  ...
  /*** SPI_DSCTRL - QSPI 0 Data Size and Control Register; 0x0000F101 ***/
  union {
    word Word;
  } SPI_DSCTRL_STR;
  ...
  /*** SPI_DRCV - QSPI 0 Data Receive Register; 0x0000F102 ***/
  union {
    word Word;
  } SPI_DRCV_STR;
  ...
  /*** SPI_DXMIT - QSPI 0 Data Transmit Register; 0x0000F103 ***/
  union {
    word Word;
  } SPI_DXMIT_STR;
...
typedef volatile struct {
  ...
  #define OCCS_STAT_ZSRC0_MASK          1U
  #define OCCS_STAT_ZSRC1_MASK          2U
  ...
  #define OCCS_STAT_ZSRC_MASK           3U
  #define OCCS_STAT_ZSRC_BITNUM         0U
...
typedef volatile struct {
  ...
  #define PMC_CR2_TRIM0_MASK            1U
  #define PMC_CR2_TRIM1_MASK            2U
  #define PMC_CR2_TRIM2_MASK            4U
  #define PMC_CR2_TRIM3_MASK            8U
  #define PMC_CR2_TRIM4_MASK            16U
  ...
  #define PMC_CR2_TRIM_MASK             31U
  #define PMC_CR2_TRIM_BITNUM           0U
...
*******************************************/
typedef volatile struct {
  /*** PIT_CTRL - PIT 0 Control Register; 0x0000F2E0 ***/
  union {
    word Word;
  } PIT_CTRL_STR;
  ...
  /*** PIT_MOD - PIT 0 Modulo Register; 0x0000F2E1 ***/
  union {
    word Word;
  } PIT_MOD_STR;
  ...
  /*** PIT_CNTR - PIT 0 Counter Register; 0x0000F2E2 ***/
  union {
    word Word;
  } PIT_CNTR_STR;
...
typedef volatile struct {
  ...
  #define FM_OPT0_IFR_OPT00_MASK        1U
  #define FM_OPT0_IFR_OPT01_MASK        2U
  #define FM_OPT0_IFR_OPT02_MASK        4U
  #define FM_OPT0_IFR_OPT03_MASK        8U
  #define FM_OPT0_IFR_OPT04_MASK        16U
  #define FM_OPT0_IFR_OPT05_MASK        32U
  #define FM_OPT0_IFR_OPT06_MASK        64U
  #define FM_OPT0_IFR_OPT07_MASK        128U
  #define FM_OPT0_IFR_OPT08_MASK        256U
  #define FM_OPT0_IFR_OPT09_MASK        512U
  #define FM_OPT0_IFR_OPT010_MASK       1024U
  #define FM_OPT0_IFR_OPT011_MASK       2048U
  #define FM_OPT0_IFR_OPT012_MASK       4096U
  #define FM_OPT0_IFR_OPT013_MASK       8192U
  #define FM_OPT0_IFR_OPT014_MASK       16384U
  #define FM_OPT0_IFR_OPT015_MASK       32768U
  ...
  #define FM_OPT1_IFR_OPT10_MASK        1U
  #define FM_OPT1_IFR_OPT11_MASK        2U
  #define FM_OPT1_IFR_OPT12_MASK        4U
  #define FM_OPT1_IFR_OPT13_MASK        8U
  #define FM_OPT1_IFR_OPT14_MASK        16U
  #define FM_OPT1_IFR_OPT15_MASK        32U
  #define FM_OPT1_IFR_OPT16_MASK        64U
  #define FM_OPT1_IFR_OPT17_MASK        128U
  #define FM_OPT1_IFR_OPT18_MASK        256U
  #define FM_OPT1_IFR_OPT19_MASK        512U
  #define FM_OPT1_IFR_OPT110_MASK       1024U
  #define FM_OPT1_IFR_OPT111_MASK       2048U
  #define FM_OPT1_IFR_OPT112_MASK       4096U
  #define FM_OPT1_IFR_OPT113_MASK       8192U
  #define FM_OPT1_IFR_OPT114_MASK       16384U
  #define FM_OPT1_IFR_OPT115_MASK       32768U
